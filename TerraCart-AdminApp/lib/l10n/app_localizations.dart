...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'settings.clear_kot': 'Clear KOT',
      'settings.clear_kot_subtitle': 'Hide completed old KOTs from your screen',
      'settings.clear_kot_title': 'Clear KOT List',
      'settings.clear_kot_message':
          'This will clear current KOTs from your cook view. New KOTs will still appear.',
      'settings.clear_kot_success': 'KOT list cleared successfully.',
